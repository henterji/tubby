...
export class UserService {
  ...
  public create(user: User, password: string): Observable<Response> {
    let params = new URLSearchParams();
    params.set('password', password);
    return this.http.post(`${this.appConfig.apiUrl}/api/user-info`, user, { search: params });
  }

  public updateMe(user: User, password: string): Observable<Response> {
    let params = new URLSearchParams();
    params.set('password', password);
    return this.http.put(`${this.appConfig.apiUrl}/api/user-info/${user.userId}`, user, { search: params });
  }
